...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-5807%2B_%2F_486_files-22C55E" alt="5807+ tests / 486 files">
...
All seventeen trees stay in key parity (`pnpm run i18n:check`). Language selection persists via `localStorage`. Selector available in Settings, the Welcome Portal, and the Command Palette.
...
| **Testing**          | Vitest 4.x (5807+ tests / 486 files) + Playwright E2E    | Unit/integration + cross-browser E2E; Stryker mutation (manual workflow)          |
...
├── tests/
│   ├── unit/             # Vitest unit tests (5807+ tests, 486 files)
...
- **5807+ unit tests** across **486 test files** — all passing
