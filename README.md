...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Version-v1.22.0-6366F1" alt="v1.22.0">
  ...
  <img src="https://img.shields.io/badge/Tests-5807%2B_%2F_501_files-22C55E" alt="5807+ tests / 501 files">
...
| **Testing**          | Vitest 4.x (5807+ tests / 501 files) + Playwright E2E    | Unit/integration + cross-browser E2E; Stryker mutation (manual workflow)          |
...
├── tests/
│   ├── unit/             # Vitest unit tests (5807+ tests, 501 files)
...
- **5807+ unit tests** across **501 test files** — all passing
