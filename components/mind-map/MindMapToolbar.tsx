  ...
  return (
    <div className="flex items-center gap-2 p-2 border-b border-[var(--sc-border-subtle)] bg-[var(--sc-surface-raised)]">
      <button
        ...
        className="p-2.5 md:p-1.5 min-h-touch min-w-touch flex items-center justify-center rounded-sc-sm hover:bg-[var(--sc-surface-overlay)] text-[var(--sc-text-secondary)]"
