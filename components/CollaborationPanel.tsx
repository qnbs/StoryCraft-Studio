...
export const CollaborationPanel: FC<CollaborationPanelProps> = ({
  ...
  return (
    <>
      ...
      {/* Drawer */}
      <aside
        className="fixed right-0 top-0 h-full w-full max-w-sm bg-[var(--background-primary)] border-l border-[var(--border-primary)] shadow-2xl z-50 flex flex-col overflow-hidden"
        role="complementary"
