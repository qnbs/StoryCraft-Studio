...
const target = 'let spineRef = `<itemref idref="titlepage"/>`;';
const replacement = `let spineRef = \`<itemref idref="titlepage"/>\`;
        if (synopsis) {
...
// fix downloadEpub deps
content = content.replace('}, [project, contentToExport]);', '}, [project, contentToExport, synopsis]);');

fs.writeFileSync(filepath, content);
console.log("Updated EPUB logic.");
