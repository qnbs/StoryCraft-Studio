...
### P0 — Release Unblock
- ✅ **P0-1** — Tauri Desktop Pipeline: Migrated pnpm config from `package.json` to `pnpm-workspace.yaml` to fix `ERR_PNPM_LOCKFILE_CONFIG_MISMATCH` on all CI runners (Vercel, Tauri, GitHub Actions). Commit `946045e`.
